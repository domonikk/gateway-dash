...
const Index = () => {
  return (
    <div className="min-h-screen bg-gradient-bubblegum">
      {/* Navigation */}
      ...
      <main className="px-6 py-16 max-w-7xl mx-auto">
        ...
        <div className="flex justify-center mt-16 mb-20">
          <div className="relative">
            <img 
              src="/lovable-uploads/74372ba7-426d-4e85-bd6d-beaf65b66392.png" 
              alt="TicketFlow App Preview" 
              className="max-w-sm md:max-w-md lg:max-w-lg drop-shadow-2xl"
            />
          </div>
        </div>
      </main>
